...
exports.action = exports.triggerEvent = exports.useMutateAction = exports.useLoadAction = exports.useData = void 0;
/**
 ...
 */
function useData(prop, propDefault) {
 ...
 */
function useLoadAction(actionName, defaultValue, params) {
    throw new Error('Not implemented');
}
exports.useLoadAction = useLoadAction;
/**
 ...
 * };
 */
function useMutateAction(actionName) {
    throw new Error('Not implemented');
}
exports.useMutateAction = useMutateAction;
/**
...
function action(name, type, config) {
    return {
        name,
        type,
        config,
